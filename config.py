...
__C.video.Scale   = 0.5        # default value=1, This down-scales video frames in height, recommended 0.5 to 1.0
...
__C.motion.maskLeft  = 175    # default = 350 Time stamp left (xmin-axis)
__C.motion.maskRight = 940   # default = 580, Time stamp right (xmax-axis)
__C.motion.maskUp    =  25    # default = 50, Time stamp upper (ymin-axis)
__C.motion.maskDwon  = 155    # default 110,  Time stamp lower (ymax-axis)

__C.motion.redBox  = True # to make red-box (square) visible
__C.motion.blueBox = False # to make blue-box (rectangle/contoure) visible
